...
Fenced code blocks render as a dark-gray ANSI color block with a two-character outer margin, two-character inner padding, and a two-character right padding after the longest code line. Pipe tables are column-aligned and use one horizontal space inside each cell.
